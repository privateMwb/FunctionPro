...
static void replaces_existing_binding() {
...
static void ref_rebinds_referent() {
    Multiplier a{2};
    Multiplier b{5};
...
static void run_tests() {
    RUN(replaces_existing_binding);
    RUN(releases_old_heap);

    RUN(ref_rebinds_referent);
}
