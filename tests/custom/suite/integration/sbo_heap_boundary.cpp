...
static void repeated_boundary_transitions() {
...
static void moveonly_boundary_transitions() {
    auto t1 = std::make_shared<int>(1);
    auto t2 = std::make_shared<int>(2);
    auto t3 = std::make_shared<int>(3);
    auto t4 = std::make_shared<int>(4);
...
static void rebinds_varying_referents() {
    int small = 5;
...
static void run_tests() {
    RUN(repeated_boundary_transitions);
    RUN(moveonly_boundary_transitions);
    RUN(rebinds_varying_referents);
}
