...
// an independent copy.
static void copy_sbo_independent() {
...
static void copy_heap_independent() {
...
static void ref_copy_shares_object() {
    Multiplier m{2};
...
static void run_tests() {
    RUN(copy_sbo_independent);
    RUN(copy_heap_independent);

    RUN(ref_copy_shares_object);
}
