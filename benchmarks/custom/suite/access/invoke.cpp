...
static void bench_function_ref_invoke() {
    ...
    BENCH("FnRef::call()", c, s);
#else
    BENCH_SOLO("FnRef::call()", c);
#endif
}
...
static void bench_function_ref_invoke_empty() {
    ...
    BENCH("FnRef::call(empty)", c, s);
#else
    BENCH_SOLO("FnRef::call(empty)", c);
#endif
}
...
static void bench_function_ref_invoke_fnptr() {
    ...
    BENCH("FnRef::call(fnptr)", c, s);
#else
    BENCH_SOLO("FnRef::call(fnptr)", c);
#endif
}
