...
static void bench_function_move_small() {
    ...
    BENCH("Fn move-ctor(small)", cExpr, sExpr);
}
...
static void bench_function_move_large() {
    ...
    BENCH("Fn move-ctor(large)", cExpr, sExpr);
}
...
static void bench_move_only_move_small() {
    ...
    BENCH("MoFn move-ctor(small)", cExpr, sExpr);
#else
    BENCH_SOLO("MoFn move-ctor(small)", cExpr);
#endif
}
...
static void bench_move_only_move_large() {
    ...
    BENCH("MoFn move-ctor(large)", cExpr, sExpr);
#else
    BENCH_SOLO("MoFn move-ctor(large)", cExpr);
#endif
}
...
static void bench_function_ref_move() {
    ...
    BENCH("FnRef move-ctor", cExpr, sExpr);
#else
    BENCH_SOLO("FnRef move-ctor", cExpr);
#endif
}
